...
/**
 * Offer accents are deliberately kept in one family with the brand blue so the
 * carousel reads as a single set of coupons rather than a bag of stickers.
 */
export const offers = [
  {
    id: "first-trip",
    ...
    subtitle: "Valid on every car in the fleet, no minimum booking length.",
    code: "FIRST500",
    terms: "One use per account",
    expires: "31 Dec 2026",
    from: "#0b4a6f",
    to: "#0ea5e9",
  },
  {
    ...
    subtitle: "Book a full week and the daily rate drops for every day of it.",
    code: "WEEK15",
    terms: "Minimum 7 day booking",
    expires: "30 Sep 2026",
    from: "#123a6b",
    to: "#4f7fd4",
  },
  {
    ...
    subtitle: "Pick up between Monday and Thursday and save on the whole trip.",
    code: "WEEKDAY10",
    terms: "Pickup Mon to Thu only",
    expires: "31 Oct 2026",
    from: "#0d5c56",
    to: "#14b8a6",
  },
  {
    ...
    subtitle: "Keep the car for a month with insurance and servicing included.",
    code: "GOA30",
    terms: "Goa pickups, 30 days+",
    expires: "31 Mar 2027",
    from: "#3d2a75",
    to: "#8b7bf0",
  },
  {
    ...
    value: "8%",
    unit: "OFF",
    title: "Airport pickups, minus the queue",
    subtitle: "Car waiting in the terminal car park when your flight lands.",
    code: "FLY8",
    terms: "Airport hubs only",
    expires: "31 Dec 2026",
    from: "#5a2a12",
    to: "#f0913a",
  },
  {
    ...
    value: "20%",
    unit: "OFF",
    title: "Two weeks out, twenty percent off",
    subtitle: "The longer the road trip, the cheaper every single day gets.",
    code: "ROAD20",
    terms: "Minimum 14 day booking",
    expires: "30 Nov 2026",
    from: "#14532d",
    to: "#43b96b",
  },
...
export const coupons = {
  ...
  FLY8: { type: "percent", value: 8, label: "8% off airport pickups" },
  ROAD20: { type: "percent", value: 20, label: "20% off 14 day rentals" },
};
